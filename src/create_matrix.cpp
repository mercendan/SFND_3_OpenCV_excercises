...
void createMatrix1()
{
    ...
    cv::Mat m3_8u;
    m3_8u.create(nrows, ncols, CV_8UC3); // multi (three)channel matrix with 8bit unsigned elements
    m3_8u.setTo(cv::Scalar(255, 0, 0)); //first channel is set to 255
    //cout << "m3_8u (python)  = " << endl << format(m3_8u, cv::Formatter::FMT_PYTHON) << endl << endl;
    ...
    // show result
    string windowName2 = "Display m3_8u";
